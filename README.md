...
* **Windows:** PowerShell (`Invoke-RestMethod`; _experimental and untested!_)
...
*Note*: The code in this package was partly written by LLMs and I have tested it only on Mac and on Unix (specifically, the NBER server). **I have not tested at all on Windows!** Please [open a github issue (or ideally a pull request)](https://github.com/lukestein/stata_ntfy) if you encounter any problems.
